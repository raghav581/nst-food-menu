...
- [ ] Admin
  ...
  - [ ] Edit existing menu
  - [ ] Delete menu
  - [x] Publish menu for current week

- It should be mobile responsive.

Pages:

- [x] 1. MenuPage - shows current week menu
- [ ] 2. AdminPage - for admin tasks
  - [ ] 2.1 List of menus
    - [ ] 2.1.1 Edit button
    - [ ] 2.1.2 Delete button
    - [ ] 2.1.3 Add New Menu button
    - [x] 2.1.4 Publish button
  - [x] 2.2 EditMenuPage - for editing/adding menu
- [x] 3. LoginPage - for admin login
